...
def add_print_formats():
	frappe.reload_doc("uae_compliance", "print_format", "detailed_tax_invoice")
	frappe.reload_doc("uae_compliance", "print_format", "simplified_tax_invoice")
	frappe.reload_doc("uae_compliance", "print_format", "tax_invoice")
